  ...
  return (
    <div className="max-w-7xl mx-auto px-4">
      <div className="w-full mx-auto">
        <div className="bg-white rounded-3xl p-8 mb-5 shadow-md">
          <h1 className="text-3xl font-bold mb-10">Dashboard for Book Inventory</h1>
          <div className="flex items-center justify-between mb-5">
            <div className="flex items-stretch">
              <div className="text-gray-400 text-xs">Members <br />connected</div>
              <div className="h-full border-l mx-4"></div>
              <div className="flex flex-nowrap -space-x-3">
                <div className="h-9 w-9">
                  <img className="object-cover w-full h-full rounded-full" src="https://ui-avatars.com/api/?background=random" alt="Member 1" />
                </div>
                <div className="h-9 w-9">
                  <img className="object-cover w-full h-full rounded-full" src="https://ui-avatars.com/api/?background=random" alt="Member 2" />
                </div>
              </div>
            </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-x-20">
            <div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div className="p-4 bg-yellow-100 rounded-xl text-gray-800 shadow-sm">
                ...
                <div className="col-span-1 md:col-span-2">
                  <div className="p-4 bg-purple-100 rounded-xl text-gray-800 shadow-sm">
            ...
            <div>
              ...
              <div className="space-y-4">
                <div className="p-4 bg-white border rounded-xl text-gray-800 space-y-2 shadow-sm">
